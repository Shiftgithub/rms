    ...
    <div id="top" class="container">
        ...
        <table class="table">
            ...
            <form action="{{url('/orderconfirm')}}" method="POST">
                ...
                <tr style="position: relative; top: -60px; right: -760px;">
                    <td><a href="{{url('/cartremove',$data2->id)}}" class="btn btn-danger">Remove</a></td>
                </tr>
                @endforeach
                    ...
                    <div class="container" id="appear" style="display: none;">
                        ...
                        <div class="text-center">
                            <button type="submit" type="submit" class="btn btn-success">Order Confirm</button>
